...
namespace JustPlanes.Unity
{
    ...
    public class Debugger : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            {
                Dictionary<string, Unit>.ValueCollection unitViews = UnitViewManager.Instance.GetOnlineUnits().Values;
        ...
        private void UnitInfo(UnitEventType type, Core.Unit unit, int val = 0)
        {
